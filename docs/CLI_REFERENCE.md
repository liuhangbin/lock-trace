...
lock-trace --tree lock-check my_function spinlock_var

# Show all paths
lock-trace --verbose lock-check my_function spinlock_var

# Exclude test and debug code paths
lock-trace --exclude-functions test_func,debug_helper lock-check my_function spinlock_var
```
...
# Track single lock
lock-trace lock-context my_function rtnl_net_lock

# Tree view (analyze all locks)
lock-trace --tree lock-context my_function

# Tree view with specific locks
lock-trace --tree lock-context my_function spinlock_var

# Show all paths
lock-trace --verbose lock-context my_function rtnl_net_lock
...
lock-trace unprotected my_function spinlock_var,mutex_var
...
lock-trace --exclude-functions error_handler,panic unprotected my_function spinlock_var
```
...
lock-trace --tree lock-context my_func lock1,lock2
