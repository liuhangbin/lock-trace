...
```bash
# Check if my_function is called under spinlock_var protection (default: unique call chains)
lock-trace lock-check my_function spinlock_var

# Show as tree structure
lock-trace lock-check my_function spinlock_var --tree

# Show all paths including duplicates
lock-trace lock-check my_function spinlock_var --verbose
```
...
lock-trace lock-context my_function --locks spinlock_var,mutex_var
...
lock-trace unprotected my_function --required-locks spinlock_var,mutex_var

# Show as tree structure
lock-trace unprotected my_function --required-locks spinlock_var --tree

# Show all paths including duplicates
lock-trace unprotected my_function --required-locks spinlock_var --verbose
```
...
======================================================================
  1: caller1 → my_function
     Held locks: spinlock_var
     Lock operations:
       acquire spinlock_var (spinlock) in caller1
